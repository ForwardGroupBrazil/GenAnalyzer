...
class SDWAnalyzer: public edm::EDAnalyzer {
  ...
  private:
    ...
    bool lepton1, metparticle, disystem, leptonAcceptance;
    bool single_gap, double_gap;
    bool wboson, wboson_diff;
    bool HF_CASTOR_gap;
    bool protonplus;
    bool protonminus;
    bool ptcut;
...
void SDWAnalyzer::beginJob(){
  ...
  std::string step1 = "CMS_disystem";
  std::string step2 = "CMS_disystemPt";
  std::string step3 = "CMS_BosonW";
...
void SDWAnalyzer::analyze(const edm::Event & ev, const edm::EventSetup&){
  ...
  lepton1 = false; metparticle = false; disystem = false, leptonAcceptance = false;
  single_gap = false; double_gap = false;
  wboson = false; wboson_diff = false;
  HF_CASTOR_gap = false;
  protonplus = false;
  protonminus = false;
  ptcut = false;
  ...
  if (lepton1 && metparticle) disystem = true;
  ...
  if(disystem){
    ...
    if (debug){
      ...
      std::cout << "Boson W("<< diboson_px << "," << diboson_py << "," << diboson_pz << "," << diboson_energy << ") [GeV]" << std::endl;
